          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-lg font-medium text-gray-900">所在地</h3>
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-lg">
              <h3 className="text-lg font-medium text-gray-900 mb-2">レスポンス時間</h3>
              <p className="text-gray-600">
                通常24時間以内にご返信いたします。お急ぎの場合は、件名に「緊急」とお書きください。
              </p>
            </div>
          </div>
        </div>
